...
def record_and_recognize_audio(*args: tuple):
    ...
    with microphone:
        ...
        try:
            print("Listening...")
            audio = recognizer.listen(microphone, 100, 10)
...
def play_greetings(*args: tuple):
    ...
    "Привет, пользователь! Я - голосовой помощник Виктория. Я могу перевести текст. Ввести запрос в браузере. Подбросить монетку. Найти информацию в викепедии. Открыть программу на компьютере. Запустить видео на Ютуб")
...
def name_trigger(*args: tuple):
    ...
    play_voice_assistant_speech("Я могу выполнять следующие команды. Перевод текста. Ввести запрос в браузере. Подбросить монетку. Найти информацию в викепедии. Открыть программу на компьютере. Запустить видео на Ютуб.")
...
"""
commands = {
    ("подбрось", "heads", "монетка", "орёл и решка","сыграем в монетку"): flip_a_coin,
...
play_voice_assistant_speech("Привет, пользователь! Я - голосовой помощник Виктория. Я могу перевести текст. Найти информацию в браузере. Подбросить монетку. Открыть программу на компьютере. Запустить видео на Ютуб")
